...
if platform.system() == "Windows":
    windowsos = True
    mydir = r"C:\Users\bharg\Downloads\chess-robot-main (1)\chess-robot-main\version2\images" + "\\"
    stockfishexe = r"C:\Users\bharg\OneDrive\Desktop\stockfish_15.1_win_x64_avx2\stockfish-windows-2022-x86-64-avx2.exe"
    cameraportno = 1
    #cameraportno = 0
